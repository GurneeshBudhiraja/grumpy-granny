...
export const App = () => {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="absolute -bottom-[180px] left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-2 sm:px-4 pb-2 sm:pb-4">
        <div className="relative w-full flex justify-center">
          {/* Computer Monitor Image - Responsive */}
          <img
            src="/computer-monitor.png"
            alt="Vintage Computer Monitor"
            className="w-full max-w-24xl sm:max-w-3xl md:max-w-4xl lg:max-w-5xl h-auto object-contain drop-shadow-2xl"
