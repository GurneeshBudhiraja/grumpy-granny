    ...
    >
      ...
      >
        ...
        <div className="flex space-x-1 granny-rotating-face">
          <img src="/granny-face-shots/granny-face-laughing.webp" className="w-10 h-10" />
        </div>
      </div>
      ...
      {!isTypingComplete && !isSkipped && (
        <button
          onClick={handleSkip}
          className="fixed bottom-4 right-7 font-windows text-xs px-3 py-1 rounded border border-button-shadow text-highlight-bg bg-window-bg cursor-pointer transition hover:bg-gray-200 z-10"
        >
          Show full rules
        </button>
      )}
